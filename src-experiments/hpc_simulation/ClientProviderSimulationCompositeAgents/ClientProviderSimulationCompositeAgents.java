...
public class ClientProviderSimulationCompositeAgents {
	...
	public static void addContextToUserAgentsList(LocalPylon pylon, ArrayList<UserCompositeAgent> agentList) {
    ...
    public static void addShardsToUsersList( ArrayList<UserCompositeAgent> users) {
        ...
        for(int i = 0; i < users.size(); i++){
			...
			shards.add(new LocalPylon.SimpleLocalMessaging());
	...
	public static void addContextToProviderAgentsList(LocalPylon pylon, ArrayList<ProviderCompositeAgent> agentList) {
