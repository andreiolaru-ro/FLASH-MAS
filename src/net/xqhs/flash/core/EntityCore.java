...
import static net.xqhs.flash.core.agent.AgentEvent.AgentEventType.AGENT_START;
import static net.xqhs.flash.core.agent.AgentEvent.AgentEventType.AGENT_STOP;
 ...
 */
public class EntityCore<P extends Entity<?>> extends Unit
		implements ConfigurableEntity<P>, Serializable, RecorderSupport {
	/**
	 * The serial UID.
	 */
	...
	/**
	 * [RECORDER HOOK] We extend the logging method from the parent class Unit Intercepted calls: li() info, le() error,
	 * lf() trace, etc.
	 */
	@Override
