...
/**
 * A simple extension of {@link MessagingShard}, which leaves only {@link #sendMessage(String, String, String)} as
 ...
 * agent with a name containing a slash (or whatever {@link MessagingShard#ADDRESS_SEPARATOR} is set to).
 * 
 * @author Andrei Olaru
 */
public abstract class NameBasedMessagingComponent extends MessagingShard
{
	/**
	 * The serial UID.
	 */
