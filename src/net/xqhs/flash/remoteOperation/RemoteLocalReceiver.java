 ...
 * <p>
 * An update is an {@link AgentWave} in which the first destinations are the update operation, the entity for which
 * there is an update, the port, and optionally the role.
 */
