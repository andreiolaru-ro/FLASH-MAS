...
public class WebSocketPylon extends DefaultPylonImplementation {
	...
	class WebSocketPylonProxy implements WaveMessagingPylonProxy {

		/**
		 * The entity is both: - registered within the local instance which is useful
		 * for routing a message back to the the {@link WaveReceiver} instance when it
		 * arrives from the server - registered to the {@link WebSocketServerEntity}
		 * using an entity registration format message which is sent by the local client
		 * 
		 * @param entityName - the name of the entity
		 * @param receiver   - the {@link WaveReceiver} instance to receive messages
	...
	public WebSocketPylon() {
		messagingProxy = new InteroperableWebSocketPylonProxy();
	}
