package interfaceGenerator.demo;

import net.xqhs.flash.core.shard.AgentShardCore;
import net.xqhs.flash.core.shard.AgentShardDesignation;

public class DemoShard extends AgentShardCore {
    /**
     ...
     * parent agent or on other shards, as when the shard is created, the {@link AgentShardCore} member is
     ...
     *
     * @param designation - the designation of the shard, as instance of {@link DemoShard}.
     */
    protected DemoShard(AgentShardDesignation designation) {
        super(designation);
    }
}
