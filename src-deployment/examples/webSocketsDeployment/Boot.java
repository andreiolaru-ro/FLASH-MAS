...
public class Boot
{
	...
	public static void main(String[] args)
	{
		...
		test_args += " -support websocket:slave1 serverPort:8885 connectTo:ws://localhost:8885 classpath:websockets.WebSocketPylon";
		test_args += " -agent AgentA classpath:examples.simplePingPong.AgentPingPong otherAgent:AgentB";
		
		test_args += " -node node2";
		test_args += " -support websocket:slave2 connectTo:ws://localhost:8885 classpath:websockets.WebSocketPylon";
