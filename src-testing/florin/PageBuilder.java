...
import florin.generator.SwingUiGenerator;
import florin.generator.UIGenerator;
import florin.generator.WebUiGenerator;
import florin.web.Input;
...
public class PageBuilder {
    ...
    public Object buildPage(GlobalConfiguration data) throws Exception {
    ...
    public GlobalConfiguration buildPageFile(String path) {
    ...
    public GlobalConfiguration buildPageInline(String inline) {
        Yaml yaml = new Yaml();
        return yaml.loadAs(inline, GlobalConfiguration.class);
    }
