...
public class PrimeNumberSimulationCompositeAgents {
	...
	public static void addContextToAgentList(LocalPylon pylon, ArrayList<PrimeNumberCompositeAgent> agentList) {
    ...
    public static void main(String[] args) {
		...
		LocalPylon.SimpleLocalMessaging messagingShardMaster = masterAgent.getMessagingShard();
