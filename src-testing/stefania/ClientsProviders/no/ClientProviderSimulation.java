...
//    public static void addContextToUserAgentsList(MPISupport pylon, ArrayList<UserAgent> agentList) {
//
...
//    }
//
//    public static void addContextToProviderAgentsList(MPISupport pylon, ArrayList<ProviderAgent> agentList) {
//
//        for(int i = 0; i < agentList.size(); i++) {
//            agentList.get(i).addContext(pylon.asContext());
//        }
...
//    }
    ...
    public static AgentShardCore getShardFromService(ProviderServices service){
...
//            addRequestsToUsersList(users);
            ...
            // TODO service depending on rank for randomness
            addRandomRequests(userAgent, ProviderServices.EVEN_NUMBERS, ProviderServices.values());
            userAgent.start();
        } else {
...
//            addShardsToProvidersList(providers);
            ...
            addRandomShards(providerAgent, ProviderServices.EVEN_NUMBERS, ProviderServices.values());
            providerAgent.start();
        }
