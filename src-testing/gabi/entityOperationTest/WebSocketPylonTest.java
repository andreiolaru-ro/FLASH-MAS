...
public class WebSocketPylonTest {
	public static void main(String[] args) throws InterruptedException {
		...
		fMas1.route(new OperationCallWave(null, pylon.getID(), RouteOperation.REGISTER_OPERATION, false,
		...
		fMas2.route(new OperationCallWave(null, pylon2.getID(), RouteOperation.REGISTER_OPERATION, false,
		...
		agent1.callOperationWithResult(multiplyOpCall,
				x -> System.out.println("The result of the multiply operation is " + x));
