...
public class WebSocketPylonTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        node1.addAgent(agent1, new MultiTreeMap().addSingleValue(NAME_ATTRIBUTE_NAME, "agent1")
        ...
        node2.addAgent(agent2, new MultiTreeMap().addSingleValue(NAME_ATTRIBUTE_NAME, "agent2")
